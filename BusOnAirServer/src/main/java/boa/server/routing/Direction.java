...
public class Direction {
	...
	public double getDistance() {
		...
		return GeoUtil
				.getDistance2(lat, lon, s.getLatitude(), s.getLongitude());
	}
	...
	public String toString() {
		return "Direction [WALKTIME:" + getWalkTime() + ":ARRIVALTIME:"
				+ getArrivalTime() + ":NUMCHANGES:" + getNumChanges()
				+ ":MINCHANGETIME:" + getMinChangeTime() + ":WALKDISTANCE:"
				+ getWalkDistance() + ":DEPTIME:" + getDepartureTime()
				+ ":TRAVELTIME:" + getTravelTime() + ":DURATION:"
				+ getDuration() + "]";
	}
