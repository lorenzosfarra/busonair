...
public class DirectionWalk {
	...
	public DirectionWalk(boolean isChange, int duration, int distance,
			Coordinate departure, Coordinate arrival) {
		super();
	...
	public DirectionWalk(boolean isChange, int duration, int distance,
			Coordinate departure, Coordinate arrival, int stazId) {
