...
public class Stop {
	...
	public void setStopNodePropertys(Stop stop, Route route,
			Index<Node> stopLayer) {
		...
		this.underlyingNode.setProperty(Stop.STOPID, route.direction
				+ route.routeId + stop.stopId);
		this.underlyingNode.setProperty(Stop.STOPNUM,
				Integer.parseInt(stop.stopId.trim()));
		this.underlyingNode.setProperty(Stop.ROUTEID, route.direction
				+ route.routeId);
		...
		stopLayer.add(underlyingNode, Stop.STOPNUM,
				new ValueContext(Integer.parseInt(stop.stopId.trim()))
						.indexNumeric());
		stopLayer.add(underlyingNode, STOPID, route.direction + route.routeId
				+ stop.stopId);
