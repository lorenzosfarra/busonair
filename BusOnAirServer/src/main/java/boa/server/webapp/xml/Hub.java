...
public class Hub {
	...
	public Hub(Node node, Route route, Stop stop, Index<Node> hubLayer,
			Boolean isLast) {
		this.underlyingNode = node;
		...
		this.underlyingNode.setProperty(Hub.ROUTEID, route.direction
				+ route.routeId);
	...
	public Double[] getLatLon() {
		return new Double[]{(Double) this.underlyingNode.getProperty(LATITUDE),
				(Double) this.underlyingNode.getProperty(LONGITUDE)};
	}
