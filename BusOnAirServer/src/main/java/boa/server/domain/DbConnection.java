...
public class DbConnection {
	...
	public static Map<String, Object> cleanDbDirectory(Database database,
		...
		database.graph = new EmbeddedGraphDatabase(storeDir, graph
				.getKernelData().getConfigParams());

		return result;
	}

	private static Map<String, Object> removeDirectory(String storeDir)
			throws IOException {
