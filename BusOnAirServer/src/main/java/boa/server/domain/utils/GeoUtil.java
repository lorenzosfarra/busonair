...
public class GeoUtil {
	...
	public static double getDistance(double lat1, double lon1, double lat2,
			double lon2) {
		// credo che non funziona bene, utilizzare getDistance2 per calcoli piu
		// accurati

		return DefaultEllipsoid.WGS84.orthodromicDistance(lon1, lat1, lon2,
				lat2);
	}
	...
	public static double getDistance2(double lat1, double lon1, double lat2,
			double lon2) {
