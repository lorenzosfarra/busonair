...
public class ShortestPath8 {
	...
	public static void main(String[] args) throws IOException {
		...
		// Path foundPath = shortestpath.ShortestPath.shortestPath(s1, s2,
		// time);
		//
		//
		// if(foundPath != null){
		...
		ShortestPathGeo mysp = new ShortestPathGeo(time, 1400, lat1, lon1,
				lat2, lon2, 1000, Criteria.MINCHANGES);
		mysp.shortestPath();
		...
		// outPath = "(" + s.getUnderlyingNode().getId() + ":ID" + s.getId() +
		// ":STAZID" + s.getStazione().getId() + ":TIME" + s.getTime() + ")-->"
		// + outPath;
		//
		// }
		...
		//
		// String outPath = "(" + arrivo.getUnderlyingNode().getId() + ":ID" +
		// arrivo.getId() + ":STAZID" + arrivo.getStazione().getId() + ":TIME" +
		// arrivo.getTime() + ")";
		//
		//
		// Stop arr = arrivo;
		...
		// arr = arr.prevSP;
		// outPath = "(" + arr.getUnderlyingNode().getId() + ":ID" + arr.getId()
		// + ":STAZID" + arr.getStazione().getId() + ":TIME" + arr.getTime() +
		// ")-->" + outPath;
		// }
		//
