...
public class Geotest {
	...
	public static void main(String[] args) {
		...
		/*
		 * Station: node: Node[32] id: 10 name: optimes latitude: 42.35253
		 * longitude: 13.34921
		 */
		...
		Collection<Station> stations = Stations.getStations()
				.getNearestStations(lat, lon, range);

		// Collection<CheckPoint> cps = r.getNearestCheckPoints(lat, lon,
		// range);
		...
		//
		// for(Station s :
		// Stations.getStations().getAllStationsInSpatialIndex())
		// System.out.print("\n" + s);
		//
