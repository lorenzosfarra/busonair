...
public class ImportTest {
	...
	public static void importTest() {
		...
		// try{
		// int id = 1051;
		// boa.server.domain.importer.Station js = new
		// boa.server.domain.importer.Station(id, "Piazza Duomo", new
		// Coordinate(88.352, 14.349));
		...
		// Integer from = 15;
		// Integer towards = 22;
		// boa.server.importer.json.Route jr = new
		// boa.server.importer.json.Route(id, "199BIS", from, towards);
